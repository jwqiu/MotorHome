<!---
  ...
  SourceSafe: $Header: /SiteObjects/Products/ColdFusion Tags/soEditor/lite/docs/dsp_invocation.cfm 10    1/18/02 7:30p Don $
...
Optional: 
  ...
  BaseFontSize      Sets the default font size to be used in soEditor.  
