<CFSILENT>
	<!--------------------------------------------------------------------------
		...
		<CFPARAM NAME="ATTRIBUTES.Width"  DEFAULT="#CFG.Width#">
		<CFPARAM NAME="ATTRIBUTES.Height" DEFAULT="#CFG.Height#">
		<CFPARAM NAME="ATTRIBUTES.ImagesURL" DEFAULT="#CFG.ImagesURL#">
		<CFPARAM NAME="ATTRIBUTES.ImagesDirectory" DEFAULT="#CFG.ImagesDirectory#">
</CFSILENT>
