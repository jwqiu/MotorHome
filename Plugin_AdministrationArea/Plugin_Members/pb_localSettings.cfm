<CFSILENT>
	...
	<CFSET Local.CFG.PlTableOrderBy    = "MeFormalName, MeEmail">
	<CFSET Local.CFG.PlDisplayFields   = "MeFormalName, MeEmail, MeActivate">
...
--->
	...
	<CF_CHILDREN CHILDREN="Caller.Local.CFG.ChildPlugins">
		<CF_CHILD ChildName = "Listings"
				  Plural    = "Vehicle Listings"
				  Singular  = "Vehicle Listing"
				  TableName = "Listings"
				  PKField   = "LiID"
				  LinkField = "LiMemberLink"
		/>
	</CF_CHILDREN>
