<CFSILENT>
	...
	<CFSET Local.CFG.PlPlural          = "States/ Provinces">
	<CFSET Local.CFG.PlSingular        = "State/ Province">
	<CFSET Local.CFG.PlTableName       = "States">
	<CFSET Local.CFG.PlTablePrimaryKey = "StID">
	<CFSET Local.CFG.PlTableOrderBy    = "StName">
	<CFSET Local.CFG.PlDisplayFields   = "StName">
	...
	<CFSET Local.CFG.ParentTable.Name      = "Countries">
	<CFSET Local.CFG.ParentTable.PKField   = "CntID">
	<CFSET Local.CFG.ParentTable.LinkField = "StCountryLink">
	...
	<CF_FIELD 	
			...
			Note       =""
			Message    ="Please enter the state/province's name."
			Type       ="text"
			Required   ="true"
			AllowHTML  ="false"
			Verify     ="false"
	...
	<CF_CHILDREN Children="Caller.Local.CFG.ChildPlugins">
		 <CF_CHILD ChildName = "Cities"
				  Plural    = "Cities"
				  Singular  = "City"
				  TableName = "Cities"
				  PKField   = "CiID"
				  LinkField = "CiStateLink"
		/>
	</CF_CHILDREN>
