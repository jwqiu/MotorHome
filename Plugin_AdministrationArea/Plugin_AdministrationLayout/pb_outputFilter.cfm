<CFSILENT>
	...
	<CFSET RelativeHere = ReplaceNoCase(CFG.OurDirectory, CFG.WebRoot, "")>
	<CFSET RelativeHere = Replace(RelativeHere, "\", "/")>
	<CFSET BodyData = ReplaceNoCase(BodyData, '"images', '"#RelativeHere#images', "ALL")>
	<CFSET BodyData = ReplaceNoCase(BodyData, 'SRC="_JS', 'SRC="#RelativeHere#_JS', "ALL")>
	<CFSET BodyData = ReplaceNoCase(BodyData, 'HREF="styles.css', 'HREF="#RelativeHere#styles.css', "ALL")>
</CFSILENT>