<CFSILENT>
	...
	<CFSET Local.CFG.PlPlural          = "Countries">
	<CFSET Local.CFG.PlSingular        = "Country">
	<CFSET Local.CFG.PlTableName       = "Countries">
	<CFSET Local.CFG.PlTablePrimaryKey = "CntID">
	<CFSET Local.CFG.PlTableOrderBy    = "CntName">
	<CFSET Local.CFG.PlDisplayFields   = "CntName">
	...
	<CF_FIELD 	
			...
			Note       =""
			Message    ="Please enter the country's name."
			Type       ="text"
			Required   ="true"
			AllowHTML  ="false"
			Verify     ="false"
