...
<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	...
	<TR>
		...
		<FORM ACTION="#CGI.SCRIPT_NAME#?#SESSION.URLToken#" METHOD="POST">
			...
			<INPUT NAME="BreadCrumbs" TYPE="HIDDEN" VALUE="#HTMLEditFormat(ATTRIBUTES.BreadCrumbs)# : &lt;A HREF=&quot;#REQUEST.Back#&quot;&gt;#CFG.PlPlural#&lt;/A&gt;">
...
<CFIF Q_ListQuery.RecordCount>
	<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		<CFOUTPUT QUERY="Q_ListQuery" STARTROW="#IM_STARTROW#" MAXROWS="#IM_MAXROW#">
			...
			<TD ALIGN="LEFT" VALIGN="TOP">#Evaluate(Field)#</TD>
			</CFLOOP>
			<CFSET Crumbs = ATTRIBUTES.BreadCrumbs & " : <A HREF=""#REQUEST.BACK#"">" & Crumbs & "</A>">
			  <TD ALIGN="RIGHT" VALIGN="BOTTOM">
				<SELECT NAME="jumperSelect" onChange="jumper(this)">
					...
					<OPTION VALUE="#CGI.SCRIPT_NAME#?FuseAction=WebPaySiteLayoutEdit&#CFG.PlTablePrimaryKey#=#Evaluate(CFG.PlTablePrimaryKey)#&BreadCrumbs=#URLEncodedFormat(Crumbs)#&RFA=#REQUEST.Back#&#SESSION.URLToken#">View/Edit Page Layout</OPTION>
					...
					<OPTION STYLE="background-color:red; color:white" VALUE="javascript:confirmDelete('#CGI.SCRIPT_NAME#?FuseAction=#CFG.PlName#Delete&#CFG.PlTablePrimaryKey#=#Evaluate(CFG.PlTablePrimaryKey)#&RFA=#REQUEST.Back#&#SESSION.URLToken#')">Delete</OPTION>
				</SELECT>
			  </TD>
		    </TR>
			</FORM>
