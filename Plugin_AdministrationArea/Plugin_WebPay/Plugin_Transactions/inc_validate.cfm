		...
		<CFSWITCH EXPRESSION="#FieldName#">
			<CFCASE VALUE="CoPaymentProcessorWDDX">
				<CFIF NOT Len(Value)>
					<CFSET 
						...
						ATTRIBUTES.entryErrors & ";You must choose a payment processor.">
				<CFELSE>
					<CFIF Value eq "DPS">
						<CFMODULE TEMPLATE="#CFG.TopLevel#" FUSEACTION="DPS_Validate" ATTRIBUTECOLLECTION=#ATTRIBUTES#/>
						<CFSET ATTRIBUTES.entryErrors = CFMODULE.ATTRIBUTES.entryErrors>
						<CFSET Value = CFMODULE.ATTRIBUTES.WDDX>
					<CFELSE>
						<CFSET TempPP = StructNew()>
						<CFSET TempPP.Processor = Value>
						<CFWDDX ACTION="CFML2WDDX" INPUT=#TempPP# OUTPUT="Value">
					</CFIF>
				</CFIF>			
			</CFCASE>
			...
			<CFCASE VALUE="CoProcessWDDX">
				<CFIF NOT Len(Value)>
					<CFSET 
						ATTRIBUTES.entryErrors = 
						ATTRIBUTES.entryErrors & ";Internal error, contact your developers or try again.">
				<CFELSE>
					<CFPARAM NAME="ATTRIBUTES.AcceptedURL" DEFAULT="">
					<CFPARAM NAME="ATTRIBUTES.NotifyURL"   DEFAULT="">
					<CFIF NOT Len(ATTRIBUTES.AcceptedURL)>
						<CFSET 
							ATTRIBUTES.entryErrors = 
							ATTRIBUTES.entryErrors & ";Please complete the Transaction Accepted URL field.">
					</CFIF>
					<CFSET ProcessStruct = StructNew()>
					<CFSET ProcessStruct.AcceptedURL = ATTRIBUTES.AcceptedURL>
					<CFSET ProcessStruct.NotifyURL   = ATTRIBUTES.NotifyURL>
					<CFWDDX ACTION="CFML2WDDX" INPUT=#ProcessStruct# OUTPUT="Value">
				</CFIF>			
			</CFCASE>
			...
			<CFCASE VALUE="CoLayoutWDDX">
				<CFIF NOT Len(Value)>
					<CFSET 
						...
						ATTRIBUTES.entryErrors & ";Internal error, contact your developers or try again.">
				<CFELSE>
					<CFPARAM NAME="ATTRIBUTES.PaymentTitleImage"  DEFAULT="">
					<CFPARAM NAME="ATTRIBUTES.AcceptedTitleImage" DEFAULT="">
					<CFPARAM NAME="ATTRIBUTES.PaymentButton"      DEFAULT="">
					<CFPARAM NAME="ATTRIBUTES.Layout"             DEFAULT="">
					
					<CFSET LayoutStruct = StructNew()>
					<CFSET LayoutStruct.PaymentTitleImage 	= ATTRIBUTES.PaymentTitleImage>
					<CFSET LayoutStruct.AcceptedTitleImage  = ATTRIBUTES.AcceptedTitleImage>
					<CFSET LayoutStruct.PaymentButton   	= ATTRIBUTES.PaymentButton>
					<CFSET LayoutStruct.Layout   			= ATTRIBUTES.Layout>
					<CFWDDX ACTION="CFML2WDDX" INPUT=#LayoutStruct# OUTPUT="Value">
				</CFIF>			
			</CFCASE>
