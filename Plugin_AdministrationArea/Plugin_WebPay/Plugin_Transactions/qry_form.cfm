	...
	<CFLOOP QUERY="CFG.Fields">
		...
		<CFSWITCH EXPRESSION="#FieldName#">
			<CFCASE VALUE="CoPaymentProcessorWDDX">
				<!--- if what we get is not a WDDX, 
					- make a WDDX of a workable structure --->
				<CFPARAM NAME="ATTRIBUTES.#FieldName#" DEFAULT="#CFG.pb_null#">
				<CFIF NOT isWDDX(ATTRIBUTES[FieldName])>
					<CFSET temporaryStruct = StructNew()>
					<CFSET temporaryStruct.Processor = "Manual">
					<CFWDDX INPUT=#temporaryStruct# OUTPUT="ATTRIBUTES.#FieldName#" ACTION="CFML2WDDX">
				</CFIF>
			</CFCASE>
			<CFDEFAULTCASE>
