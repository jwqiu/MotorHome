...
<TABLE BORDER="0" WIDTH="100%">
	<TR>
		...
		<SELECT NAME="Manual_CardType">
			...
			<CFIF IsDefined("Config.Accept_DISCOVER") AND Config.Accept_DISCOVER >
				<OPTION VALUE="DISCOVER">Discover</OPTION>
			</CFIF>
			<CFIF IsDefined("Config.Accept_DINERS") AND Config.Accept_DINERS >
	...
	<TR>
		...
		<TD>
			<CFINPUT TYPE="TEXT" NAME="Manual_CardNumber" VALUE="" MESSAGE="Please enter the number on your credit card." VALIDATE="CREDITCARD" SIZE="20" >
		</TD>
	</TR>
	...
	<TR>
		...
		<TD>
			<SELECT NAME="Manual_CardExpiryMonth">
			...
			<SELECT NAME="Manual_CardExpiryYear">
	...
	<TR>
		...
		<TD VALIGN="TOP">
			<CFINPUT TYPE="TEXT" NAME="Manual_CardName" VALUE=""  MESSAGE="Please enter the name on your credit card." SIZE="20">
		</TD>
	</TR>
	...
	<TR>
	 ...
	 is CvC2</A>)</SMALL></TD>
		<TD>
			<CFINPUT TYPE="TEXT" NAME="Manual_CardCvC2" VALUE="" SIZE="4" MAXLENGTH="4" MESSAGE="Please enter the CvC2 number on your credit card.">
		</TD>
	</TR>
	</CFIF>
</TABLE>
