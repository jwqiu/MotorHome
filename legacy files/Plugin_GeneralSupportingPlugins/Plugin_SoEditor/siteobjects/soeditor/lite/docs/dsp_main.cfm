<!---
  ...
  SourceSafe: $Header: /SiteObjects/Products/ColdFusion Tags/soEditor/lite/docs/dsp_main.cfm 11    1/18/02 7:30p Don $
...
Usage: &lt;cf_soEditor_lite form="formname" field="fieldname" 
           ...
           [html="html"][showborders="true/false"][new="true/false"][save="true/false"]
           [cut="true/false"][copy="true/false"][paste="true/false"][delete="true/false"]
           [find="true/false"][undo="true/false"][redo="true/false"]
           [hr="true/false"][image="true/false"][link="true/false"][unlink="true/false"]
           [help="true/false"][align="true/false"][list="true/false"]
...
soEditor Lite also provides features to allow administrators to extend the functionality to include insertion of specific html blocks through the <i>insertText</i> method of the soEditor control.  By calling method with JavaScript one can insert specific text or HTML into the document being created or edited.  This feature can be used to create new functionality based on the soEditor control.
<pre>
  soEditor.insertText(sStart, sEnd, asHTML);
    ...
    asHTML      Boolean varible indicating if the text should be inserted as rendered HTML or as Plain text.
</pre>
</p> 
