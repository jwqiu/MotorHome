<CFSILENT>
	...
	<CFSET Local.CFG.SMPrefix = ReplaceNoCase(ListLast(GetDirectoryFromPath(GetCurrentTemplatePath()), "/\_"),
			"SecurityProcessor", "")>
	<CFSET Local.CFG.admin_Username = "foo">
	<CFSET Local.CFG.admin_Password = "bar">
	<CFSET Local.CFG.admin_Email    = "james">
</CFSILENT>