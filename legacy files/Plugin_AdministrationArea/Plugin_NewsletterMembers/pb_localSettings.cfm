<CFSILENT>
	...
	<CFSET Local.CFG.PlPlural          = "Newsletter Members">
	<CFSET Local.CFG.PlSingular        = "Newsletter Member">
	<CFSET Local.CFG.PlTableName       = "NewsletterMembers">
	<CFSET Local.CFG.PlTablePrimaryKey = "NeMeID">
	<CFSET Local.CFG.PlTableOrderBy    = "NeMeName,NeMeEmail">
	<CFSET Local.CFG.PlDisplayFields   = "NeMeName,NeMeEmail">
