...
<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	...
	<TR>
		...
		<CFIF ATTRIBUTES.LiMemberLink NEQ CFG.pb_Null>
		...
		<CFELSE>
			To create a new listing, please go to the members list and select <i>Vehicle Listings</i> from the member's <i>manage</i> menu.
		</CFIF>
		</TD>
		</FORM>
...
<CFIF Q_ListQuery.RecordCount>
	<TABLE WIDTH="100%" ALIGN="CENTER" BORDER="0" CELLSPACING="0" CELLPADDING="2">
		<CFOUTPUT QUERY="Q_ListQuery" STARTROW="#IM_STARTROW#" MAXROWS="#IM_MAXROW#">
			...
			<CFIF Trim(Field) EQ "LiAuthorised">
