...
<TABLE WIDTH="100%" BORDER="0" CELLSPACING="0" CELLPADDING="2">
	<CFLOOP QUERY="CFG.Fields">
		...
		<CFSWITCH EXPRESSION="#Type#">
				...
				<TR #IIF(ListFind(ATTRIBUTES.errorFields, FieldName), DE('CLASS="errorField"'), DE(''))#>
					...
					<TD ALIGN="LEFT" VALIGN="TOP">
						<CFINPUT TYPE="#Type#" NAME="#FieldName#" SIZE="#Size#" 
							...
							REQUIRED="#Required#" VALUE="#HTMLEditFormat(Value)#" 
							OnError="_PB_onError"/>
					</TD>
				</TR>
				</CFOUTPUT>
				...
				<TR #IIF(ListFind(ATTRIBUTES.errorFields, FieldName), DE('CLASS="errorField"'), DE(''))#>
					...
					<TD ALIGN="LEFT" VALIGN="TOP">
						<CFINPUT TYPE="checkbox" NAME="#FieldName#" MESSAGE="#ErrorMessage#" 
							...
							OnError="_PB_onError"/><CFIF Len(Note)>#Note#</CFIF>
					</TD>
				</TR>
				</CFOUTPUT>
				<CFIF Verify>
			...
			<CFCASE VALUE="multilookupcheckbox">
				<CFOUTPUT>
				<TR #IIF(ListFind(ATTRIBUTES.errorFields, FieldName), DE('CLASS="errorField"'), DE(''))#>
					<TD WIDTH="5" ALIGN="CENTER" VALIGN="TOP">
						<CFIF Required><SPAN CLASS="required">*</SPAN></CFIF>
					...
					<TD ALIGN="LEFT" VALIGN="TOP">
							...
							<CFSET FName	= FieldName>
							<CFLOOP QUERY="Q_Lookup">
								<INPUT TYPE="CHECKBOX" NAME="#FName#" VALUE="#Evaluate(ValField)#" #IIF(ListFind(SelVal, Evaluate(ValField)), DE('checked'), DE(''))#>#HTMLEditFormat(Evaluate(DisField))#<br>
							</CFLOOP>
					</TD>
				</TR>
				</CFOUTPUT>
