<CFSILENT>
	...
	<CFELSE>
		...
		<!--- Set validated attributes to our attributes --->
		...
		<CFIF NOT Len(ATTRIBUTES.entryErrors)>
			...
			<CFQUERY DATASOURCE="#CFG.DS#" CONNECTSTRING="#CFG.CONNECTSTRING#" 
	        	...
	        	INSERT INTO #CFG.PlTableName#
					...
					<CFOUTPUT QUERY="CFG.Fields">
						<CFIF IsDefined("ATTRIBUTES.#FieldName#") AND Type neq "multilookup" AND Type neq "multilookupcheckbox">
								, #FieldName#
						</CFIF>
					</CFOUTPUT>
			...
			<CFLOOP QUERY="CFG.Fields">
				<CFIF ((Type eq "multilookup") or (Type eq "multilookupcheckbox")) AND IsDefined("ATTRIBUTES.#FieldName#")>
