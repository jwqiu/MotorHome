<CFSILENT>
	...
	<CFSET Local.CFG.PlPlural          = "Vehicle Types">
	<CFSET Local.CFG.PlSingular        = "Vehicle Type">
	<CFSET Local.CFG.PlTableName       = "VehicleTypes">
	<CFSET Local.CFG.PlTablePrimaryKey = "VeTyID">
	<CFSET Local.CFG.PlTableOrderBy    = "VeTyID">
	<CFSET Local.CFG.PlDisplayFields   = "VeTyName">
	...
	<CF_FIELD 	
			...
			Note       =""
			Message    ="Please enter the vehicle type's name."
			Type       ="text"
			Required   ="true"
			AllowHTML  ="false"
			Verify     ="false"
