    ...
    <tr> 
      ...
      <td> <table width="300" border="0" cellspacing="0" cellpadding="5">
          <TR> 
			...
			<INPUT TYPE="Checkbox" NAME="CountryList" VALUE="#CntID#">&nbsp;<span class="text">#CntName#</span><BR><BR><CFIF (Evaluate(CurrentRow MOD ((Q_Countries.RecordCount+2) / 3)) EQ 0) AND (CurrentRow NEQ Q_Countries.RecordCount)>
            </td>
...
<input name="SearchKeywords" type="text" class="formstylre"></td>
          ...
          <tr class="text"> 
            <td>&nbsp;</td>
            <td colspan="2"><input name="Submit2" type="submit" class="formstylre" value="Search"> 
            </td>
          </tr>
        </table></td>
    </tr>
...
<select name="FromDay" class="formstylre">
    ...
    <tr> 
      <td class="text">&nbsp;</td>
      <td><input name="Submit" type="submit" class="formstylreCopy" value="Search"> 
        <br> <br> </td>
    </tr>
    <tr> 
